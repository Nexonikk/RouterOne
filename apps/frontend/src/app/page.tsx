...
import { ArrowRight, Zap, Globe, Shield, BarChart3, Code2, Layers } from "lucide-react"
            ...
            <header className="fixed top-0 inset-x-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
                <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-sm font-semibold tracking-tight">RouterOne</span>
                    </div>
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="mt-4 text-muted-foreground text-lg max-w-xl mx-auto">
                            Built for developers who want to move fast without being locked into a
                            single provider.
                        </p>
                    </div>
