...
import { Key, Coins, Plus, ArrowRight, Loader2, Layers } from "lucide-react";
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Overview of your RouterOne account.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card className="bg-card/50 border-border/50">
              ...
              <CardContent>
                <p className="text-3xl font-bold tracking-tight">{activeKeys.length}</p>
            ...
            <Card className="bg-card/50 border-border/50">
              ...
              <CardContent>
                <p className="text-3xl font-bold tracking-tight">{modelCount}</p>
                <p className="text-xs text-muted-foreground mt-1">from all providers</p>
              </CardContent>
            </Card>
          </div>
        )}
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`inline-flex items-center gap-1.5 text-xs font-medium ${
                            key.disabled ? "text-muted-foreground" : "text-emerald-400"
                          }`}
                        >
                          <span
