              ...
              <div className="flex items-start gap-2.5 text-sm text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 rounded-lg px-3.5 py-3 mt-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <Button variant="ghost" size="icon-sm" onClick={() => copyToClipboard(newlyCreatedKey, "new")}>
                      {copiedId === "new" ? (
        ...
        <div>
          <h2 className="text-sm font-semibold text-white mb-4">
            ...
            {!apiKeysQuery.isLoading && (
              <span className="text-muted-foreground font-normal ml-2">({apiKeys.length})</span>
            )}
          </h2>
